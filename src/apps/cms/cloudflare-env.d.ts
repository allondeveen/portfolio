/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: de6d98575429672faaaeb8c89cf10eb5)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CMS_ORIGIN" | "FRONTEND_URL" | "MEDIA_URL" | "MAINTENANCE_BUILD_HOOK_URL" | "MAINTENANCE_BUILD_REF" | "OAUTH_CLIENT_ID" | "OAUTH_CLIENT_SECRET" | "OAUTH_JWT_SIGNING_KEY" | "PAYLOAD_SECRET" | "MAINTENANCE_BUILD_HOOK_TOKEN" | "SEED_EMAIL" | "SEED_PASS">> {}
}
