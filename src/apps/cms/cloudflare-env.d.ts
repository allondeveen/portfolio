/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: d5e6a53a4942101eeb089cf32d9e4d6d)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CMS_ORIGIN" | "OAUTH_CLIENT_ID" | "OAUTH_CLIENT_SECRET" | "OAUTH_JWT_SIGNING_KEY">> {}
}
