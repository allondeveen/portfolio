/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 816500e3f19b4695db1e4a63defc3bbe)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CMS_ORIGIN" | "FRONTEND_URL" | "MEDIA_URL" | "MAINTENANCE_BUILD_HOOK_URL" | "MAINTENANCE_BUILD_REF" | "ENVIRONMENT" | "OAUTH_CLIENT_ID" | "OAUTH_CLIENT_SECRET" | "OAUTH_JWT_SIGNING_KEY" | "PAYLOAD_SECRET" | "MAINTENANCE_BUILD_HOOK_TOKEN" | "SEED_EMAIL" | "SEED_PASS">> {}
}
