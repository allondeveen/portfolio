/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 9dcef8162a2d04614269ee91f5969f37)
// Runtime types generated with workerd@1.20260801.1 2025-08-15 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	R2: R2Bucket;
	ASSETS: Fetcher;
	CMS_ORIGIN: "https://cms-staging.allondeveen.com" | "https://cms.allondeveen.com" | "https://cms-dev.allondeveen.com";
	FRONTEND_URL: "https://staging.allondeveen.com" | "https://www.allondeveen.com" | "https://dev.allondeveen.com";
	MEDIA_URL: "https://media-staging.allondeveen.com" | "https://media.allondeveen.com" | "https://media-dev.allondeveen.com";
	MAINTENANCE_BUILD_HOOK_URL?: "https://api.github.com/repos/allondeveen/portfolio/actions/workflows/deploy-maintenance-page.yml/dispatches";
	MAINTENANCE_BUILD_REF?: "staging" | "main";
	...
	MAINTENANCE_BUILD_HOOK_TOKEN?: string;
	SEED_EMAIL?: string;
	SEED_PASS?: string;
}
declare namespace Cloudflare {
	interface StagingEnv {
		R2: R2Bucket;
		ASSETS: Fetcher;
		CMS_ORIGIN: "https://cms-staging.allondeveen.com";
		FRONTEND_URL: "https://staging.allondeveen.com";
		MEDIA_URL: "https://media-staging.allondeveen.com";
		MAINTENANCE_BUILD_HOOK_URL: "https://api.github.com/repos/allondeveen/portfolio/actions/workflows/deploy-maintenance-page.yml/dispatches";
		MAINTENANCE_BUILD_REF: "staging";
		ENVIRONMENT: "staging";
		DATABASE_CONNECTIONSTRING: string;
		OAUTH_CLIENT_ID: string;
		OAUTH_CLIENT_SECRET: string;
	...
	interface ProductionEnv {
		R2: R2Bucket;
		ASSETS: Fetcher;
		CMS_ORIGIN: "https://cms.allondeveen.com";
		FRONTEND_URL: "https://www.allondeveen.com";
		MEDIA_URL: "https://media.allondeveen.com";
		MAINTENANCE_BUILD_HOOK_URL: "https://api.github.com/repos/allondeveen/portfolio/actions/workflows/deploy-maintenance-page.yml/dispatches";
		MAINTENANCE_BUILD_REF: "main";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CMS_ORIGIN" | "FRONTEND_URL" | "MEDIA_URL" | "MAINTENANCE_BUILD_HOOK_URL" | "MAINTENANCE_BUILD_REF" | "ENVIRONMENT" | "DATABASE_CONNECTIONSTRING" | "OAUTH_CLIENT_ID" | "OAUTH_CLIENT_SECRET" | "OAUTH_JWT_SIGNING_KEY" | "PAYLOAD_SECRET" | "MAINTENANCE_BUILD_HOOK_TOKEN" | "SEED_EMAIL" | "SEED_PASS">> {}
}
